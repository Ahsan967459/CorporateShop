...
const Signin = () => {
    ...
    const {signinUser,signWithGoogle,setUser}=useContext(context);
    ...
    const SigninUser=(e)=>{
      ...
      signinUser(email,password)
        .then((res)=>{
          setUser(res.user)
           //when user go other path that's locate..........
     ...
     //signinUser from firebase use google.....
     const signinGoogle=()=>{
       signWithGoogle()
         .then((res)=>{
          setUser(res.user)
    ...
    return (
       ...
       {/* that's for forget password.it's not work like now. */}
      ...
      {false && <div className="w-full h-screen absolute bg-gray-600/70 z-10 flex justify-center items-center">
            ...
            <div className="w-fit bg-green-400 p-8 py-11  rounded-xl">
                <form onSubmit={SigninUser} >
                    ...
                    <input  className="mb-5 w-[290px] sm:w-[360px]  py-[3px] px-4 bg-white text-black rounded" type="email" name="email" key="1a" placeholder="User Email" required />
                    <br />
                    <div className="flex relative">
                        <input key="2a" className="mb-5 w-[290px] sm:w-[360px] py-[3px] px-4 bg-white text-black rounded" type={showPassword ? "text":"password" } name="password" id="" placeholder="Password" required />
                       <div onClick={()=>setShowPassword(!showPassword)} className="absolute text-gray-500  text-[1.5rem] top-[3px] left-[71%] sm:left-[90%]">
                    ...
                    <input key="3a" className="mb-5  w-[290px] sm:w-[360px] py-[5px] px-4 rounded cursor-pointer bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 font-semibold text-white" type="submit" value="Sign in" />
               </form>
              ...
              <div>
                <div onClick={signinGoogle}  className="mb-4  w-[290px] sm:w-[360px] py-[4px] px-4 rounded bg-white text-white cursor-pointer flex"><FcGoogle className="text-[1.7rem]"></FcGoogle><div className="w-full text-center"><p className="text-gray-500">Login with Google</p></div></div>
              </div>
              {
                   googleErrorMsg && <div>
